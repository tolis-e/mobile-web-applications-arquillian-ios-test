...
public class RegistrationPage extends KitchensinkDemoPage {
    ...
    public void submitFormByButton(String id) {
        ...
        Graphene.waitModel().withTimeout(10, TimeUnit.SECONDS).until(element(submitButton).isVisible());
        submitButton.click();
    }
    ...
    public void cancel(String id) {
        ...
        Graphene.waitModel().withTimeout(10, TimeUnit.SECONDS).until(element(cancelButton).isVisible());
        cancelButton.click();
    }
    ...
    public void waitUntilSuccessMessageIsVisible(String className) {
        Graphene.waitModel().withTimeout(20, TimeUnit.SECONDS).until(element(formMsg).isVisible());
