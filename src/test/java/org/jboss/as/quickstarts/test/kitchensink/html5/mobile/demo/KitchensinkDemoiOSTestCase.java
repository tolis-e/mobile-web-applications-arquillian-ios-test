...
import org.jboss.as.quickstarts.kitchensink.html5.mobile.demo.pages.IOSPage;
 ...
 * 
 */
public class KitchensinkDemoiOSTestCase extends KitchensinkDemoTest {
    ...
    public void initialMemberListTest() {
        ...
        initializePageUrl();
        // wait until iOS page is loaded
        iOSPage.waitUntilPageIsLoaded();
        // navigate to list page
        iOSPage.navigateToListPage();
    ...
    public void addMemberTest() {
        // initialize main page
        initializePageUrl();
        // wait until the iOS page is loaded
        iOSPage.waitUntilPageIsLoaded();
        // navigate to registration page
        iOSPage.navigateToRegistrationPage();
        ...
        // initialize main page
        initializePageUrl();
        // wait until the iOS page is visible
        iOSPage.waitUntilPageIsLoaded();
        // navigate to list page
        iOSPage.navigateToListPage();
        // wait for the row list page to load
